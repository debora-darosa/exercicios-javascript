  ...
  (function() {
    ...
    class Animation {
      constructor(worldState, robot, robotState) {
        ...
        this.map.src = "https://eloquentjavascript.net/img/village2x.png"
        ...
        robotPic.src = "https://eloquentjavascript.net/img/robot_idle2x.png"
        this.parcels = []
      ...
      tick() {
        ...
        if (this.worldState.parcels.length == 0) {
          ...
          this.robotElt.firstChild.src = "https://eloquentjavascript.net/img/robot_idle2x.png"
        } else {
          this.schedule()
        }
      }
